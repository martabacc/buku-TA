...
\subsection{Perancangan}	
	...
	\begin{enumerate}
		\item Web Server, sebagai komponen utama karena aplikasi berbasis \textit{web};
	...
	\begin{figure}[t]
		\centering
		\includegraphics
		[width=.45\textwidth]		{images/bab3/buku/basic_architecture.png}
	...
	\begin{figure}[b]
		\centering
		\includegraphics[width=.5\textwidth]{images/bab3/arsitektur-app.png}
	...
	\end{figure}
		...
		Aplikasi ini tersusun atas 4 \textit{tiers}, yang dapat dilihat pada Gambar \ref{tiers}. \textit{Tiers} ini dibangun agar dapat mengakomodasi kebutuhan \textit{flexibility} dan \textit{maintainability}. \textit{Tiers} tersebut diklasifikasikan sebagai berikut:
		\begin{enumerate}
		...
		\begin{figure}[t]
			\centering
			\includegraphics[width=.3\textwidth]{images/bab3/apl/main-apl.png}
			\caption{Visualisasi arsitektur dan teknologi Final yang diterapkan dalam rancang bangun aplikasi}
			\label{tiers}
		\end{figure}
