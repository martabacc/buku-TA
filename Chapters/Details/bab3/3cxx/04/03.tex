	...
	\begin{table}[H]
		...
		\begin{tabular}{|r|p{8cm}|}
			...
			\begin{enumerate}
				...
				\item Sistem me\textit{redirect} pengguna kembali ke halaman di \cref{uc0403-1page}
			...
			\begin{itemize}
				...
				\item[\ref{al-0402-b}c.] Sistem menampilkan kembali modal di poin \cref{uc0403-modal} beserta dengan \textit{error message}
			\end{itemize}
			\\ \hline
		\end{tabular}
